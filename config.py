...
class Config:
    ...
    XAUUSD_TRAP_PENALTY_ROUND_RES: float = float(os.getenv("XAUUSD_TRAP_PENALTY_ROUND_RES", "5"))
    XAUUSD_TRAP_PENALTY_NO_CHASE: float = float(os.getenv("XAUUSD_TRAP_PENALTY_NO_CHASE", "6"))
    XAUUSD_TRAP_PENALTY_SWEEP: float = float(os.getenv("XAUUSD_TRAP_PENALTY_SWEEP", "10"))
    XAUUSD_TRAP_PENALTY_EVENT: float = float(os.getenv("XAUUSD_TRAP_PENALTY_EVENT", "8"))
    ...
    XAUUSD_TRAP_PENALTY_MACRO_SHOCK: float = float(os.getenv("XAUUSD_TRAP_PENALTY_MACRO_SHOCK", "6"))
    XAUUSD_TRAP_PENALTY_SWEEP_PROB: float = float(os.getenv("XAUUSD_TRAP_PENALTY_SWEEP_PROB", "5"))
    ...
    # ── Signal Thresholds ──────────────────────────────────────────────────────
    MIN_SIGNAL_CONFIDENCE:  int = int(os.getenv("MIN_SIGNAL_CONFIDENCE", "62"))
